...
from ..executors.executorie import IETestharnessExecutor, IEReftestExecutor
...
__wptrunner__ = {"product": "ie",
                 ...
                 "browser": "IEBrowser",
                 "executor": {"testharness": "IETestharnessExecutor",
                              "reftest": "IEReftestExecutor"},
...
class IEBrowser(Browser):
    ...
    def start(self):
        ...
        self.logger.debug("Starting iedriver")
        self.proc.run()
